      ...
      >
        <div className="product-card__icon-area">
          ...
          <div className="product-card__tags">
            ...
            <span className={`product-card__stock-tag ${isOutOfStock ? 'product-card__stock-tag--out' : product.stock < 3 ? 'product-card__stock-tag--low' : ''}`}>
        ...
        <div className="product-card__footer">
          <span className="product-card__price">Consultar</span>
